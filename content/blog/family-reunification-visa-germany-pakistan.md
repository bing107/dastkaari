...
German immigration law (Aufenthaltsgesetz) allows the following family members to join you in Germany:
...
If your child is a German citizen and you are the parent with custody, you have a stronger legal basis for family reunification under Section 28 of the Residence Act. This is a separate category with more favorable conditions.
...
You must prove you can financially support your family without relying on German social benefits (Sozialleistungen). The approximate benchmarks for 2026:

| Family Size | Approximate Monthly Net Income Required |
|---|---|
| Sponsor + Spouse | EUR 1,800 - 2,100 |
| Sponsor + Spouse + 1 Child | EUR 2,100 - 2,400 |
| Sponsor + Spouse + 2 Children | EUR 2,400 - 2,700 |

These figures vary by city because rent is factored in. A family in Munich needs significantly more than a family in Leipzig. The Ausländerbehörde (foreigners' authority) calculates the specific amount based on your rent and the social welfare threshold (Bürgergeld) plus a safety margin.

**Tip:** Your spouse's expected income in Germany is generally not counted at the application stage. Only your current verifiable income matters.

### 3. Adequate Housing

You must demonstrate that your apartment is large enough for the family. The general guideline is:

- **12 square meters per person** aged 6 and over
- **10 square meters per child** under 6

You will need to provide your rental contract showing the apartment size, or a confirmation from your landlord. A one-bedroom apartment will likely not be accepted for a family of four.

### 4. Health Insurance

You must have health insurance that will cover your family members, or they must arrange their own. Public health insurance (gesetzliche Krankenversicherung) in Germany automatically covers your spouse and children under family insurance (Familienversicherung) if they have no income. If you are privately insured, your family members each need their own private policy.

For details on choosing the right insurance, see our [Health Insurance Guide for Pakistanis in Germany](/blog/health-insurance-germany-guide-pakistanis/).

## Spouse Visa Requirements in Detail

The spouse visa is the most common family reunification visa for Pakistanis. Here is exactly what is required:
...
Other exemptions include cases where the spouse has a recognized university degree, where learning German is not possible or reasonable due to illness or disability, or where the marriage has existed for a long time and the sponsor has held a residence permit for years.

#### Where to Take the A1 Exam in Pakistan

The **Goethe-Institut** is the primary provider of recognized German language exams in Pakistan. They operate in three cities:

| City | Exam Location |
|---|---|
| **Karachi** | Goethe-Institut Karachi |
...
1. **Start early.** Give yourself at least 3-4 months of preparation time. Most people need 150-200 hours of study for A1.
2. **Enroll in a Goethe-Institut course.** They offer A1 preparation courses in Karachi, Lahore, and Islamabad, both in-person and online.
...
|---|---|---|
| Self-study or course enrollment | Month 1-3 | 1-2 hours daily study |
| Practice exams | Month 3-4 | Take 2-3 mock exams |
| Exam date | Month 4 | Sit for Goethe-Zertifikat A1 |
| Results | 2-4 weeks after exam | Certificate issued |
...
Both spouses must be at least 18 years old at the time of the visa application.

## Children's Reunification Requirements

### Children Under 16

Reunification of children under 16 is relatively straightforward. Both parents must consent (or the applying parent must have sole custody). The child does not need to demonstrate German language skills.

### Children Aged 16-17

This is more restrictive. Children aged 16 or 17 can join their parent in Germany if:

- They move **together with both parents**, OR
- They can demonstrate **C1 German language proficiency**, OR
- It can be shown that **integration into the German way of life is ensured** based on their education and life circumstances

In practice, most Pakistani families apply before children turn 16 to avoid these stricter rules.
...
As of **15 January 2026**, the German Embassy in Islamabad requires all family reunification visa applications to be submitted through the **Consular Services Portal** (digital.diplo.de). The old waiting-list and email-based system has been replaced.

Here is how the new process works:

### Step-by-Step Application Process

**Step 1: Register on the Consular Services Portal**

Go to [digital.diplo.de](https://digital.diplo.de) and create an account. The portal is available in English and German.
...
Upload all required documents as scanned PDFs. Make sure scans are clear, complete, and properly oriented. The portal performs a **preliminary scrutiny** to check completeness before you are invited for an in-person appointment.

**Step 4: Receive an Appointment**

Once the portal confirms your documents are in order, you will be assigned an appointment at the German Embassy in Islamabad for biometric data collection (fingerprints, photo) and a brief interview.

**Step 5: Attend the Embassy Appointment**

Bring all **original documents** to the appointment. You will submit biometrics, answer questions about your relationship and plans in Germany, and pay the visa fee. The embassy staff will verify your original documents against the uploaded copies.

**Step 6: Wait for Processing**

After the appointment, your application is processed. The embassy may contact the Ausländerbehörde in Germany to verify the sponsor's information.

**Step 7: Visa Decision**

You will be notified of the decision via the portal. If approved, you will collect your passport with the visa sticker from the embassy or via courier.
...
Let's be realistic about timelines. The German Embassy in Islamabad has historically been one of the slower embassies for family reunification:

| Stage | Expected Duration |
|---|---|
| A1 exam preparation and certificate | 3-5 months |
| Document collection and attestation | 2-4 weeks |
| Portal registration and preliminary review | 2-4 weeks |
| Waiting for embassy appointment | 1-3 months |
...
| Item | Cost |
|---|---|
| Goethe-Zertifikat A1 exam fee | Approximately PKR 22,000-25,000 |
| A1 preparation course (optional) | PKR 30,000-60,000 |
| Document attestation (MoFA) | PKR 2,000-5,000 per document |
| Certified translation of documents | PKR 3,000-8,000 per document |
| Visa application fee (adult) | EUR 75 (approximately PKR 25,000) |
| Visa application fee (child under 18) | EUR 37.50 (approximately PKR 12,500) |
| Travel health insurance | EUR 30-50 for the initial period |
| Residence permit fee in Germany | Approximately EUR 100 per person |
| **Total estimated cost per adult** | **EUR 300-500 (PKR 100,000-165,000)** |

Note: The visa fee is non-refundable, even if the application is rejected.

## What to Do After Arrival in Germany

Once your family member arrives with the family reunification visa, the clock starts ticking on several important tasks.
...
Your family member is **entitled to** and may be **required to** attend an integration course. This is a government-subsidized program consisting of:

- **600 hours of German language classes** (from A1 to B1 level)
- **100 hours of orientation course** (German history, legal system, culture, values)

The BAMF (Federal Office for Migration and Refugees) covers most of the cost. Participants pay a co-pay of EUR 2.29 per lesson hour, which can be waived for low-income families. Completing the integration course to B1 level helps significantly with future permanent residency and citizenship applications.
...
A family member can apply for a settlement permit after **5 years** of holding a residence permit, provided they:

- Have sufficient income and do not depend on social welfare
- Have adequate German language skills (usually B1)
- Have basic knowledge of German law and society (orientation course or equivalent)
- Have paid into the pension system for at least 60 months
- Have adequate housing

**Faster route for spouses of German citizens:** If your spouse is a German citizen, you can apply for a settlement permit after just **3 years** of marriage and residence in Germany, with B1 German and the ability to support yourself financially.

### German Citizenship

After **8 years** of legal residence (reducible to 7 with integration course completion, or 6 with B2 German), family members can apply for German citizenship (Einbürgerung). Since June 2024, Germany allows dual citizenship without restrictions, so your family member can keep their Pakistani passport.

## Common Rejection Reasons and How to Avoid Them

Understanding why applications get rejected helps you submit a stronger application:
...
**Problem:** Missing translations, documents not properly attested, or expired certificates.

**Solution:** Use the Consular Services Portal checklist carefully. Have every Pakistani document attested by the Ministry of Foreign Affairs. Get certified German translations from a recognized translator. Check expiry dates on all documents.

### 3. Doubts About the Authenticity of the Marriage
...
**Problem:** The marriage was conducted by phone without both parties physically present.

**Solution:** German authorities check passport stamps to verify physical presence. If your nikah was telephonic, you may need to have a new in-person ceremony before applying.

### 6. Inadequate Housing

**Problem:** The apartment is too small for the family size, or no proper rental contract is provided.

**Solution:** Ensure your apartment meets the 12 sqm per person guideline. If you need a bigger apartment, move before filing the application. Provide a clear rental contract showing the size.

### 7. Health Insurance Issues

**Problem:** No proof of coverage, or insurance start date is more than one month from expected travel.

**Solution:** Arrange travel health insurance with a start date within one month of your expected entry. For long-term coverage, confirm your German health insurance provider will cover family members under Familienversicherung.

### 8. Sponsor's Residence Permit Does Not Allow Family Reunification

**Problem:** Certain temporary permits or tolerated stays do not include family reunification rights.

**Solution:** Check with your Ausländerbehörde whether your specific permit allows family reunification before your family member starts the application process.

## Special Cases for Pakistani Applicants
...
Recognized refugees have special rules under Section 29(2) AufenthG. If you apply within 3 months of receiving refugee status, income and housing requirements may be waived. After 3 months, standard requirements apply.

### Students

Family reunification on a student visa is technically possible but very difficult. You must prove full financial support for your family without working more than your permitted hours and without relying on public funds. Most students wait until they have a work visa or Blue Card before applying.

## Frequently Asked Questions

**Q: Can my family apply from a country other than Pakistan?**
A: Yes, your family member can apply at the German embassy in any country where they have legal residence. However, applying from Pakistan is the standard route.

**Q: What if my spouse fails the A1 exam multiple times?**
A: There is no limit on retakes. However, after one year of unsuccessful attempts, some cases qualify for a hardship exemption. Consult an immigration lawyer if this applies.

**Q: Can my family members travel to Germany on a tourist visa and then switch to a family reunification permit?**
A: No. Entering on a Schengen tourist visa and switching to a family reunification residence permit inside Germany is not permitted. They must apply for the correct visa category from Pakistan.

**Q: How long is the family reunification visa valid?**
...
| Month | Action |
|---|---|
| Month 1 | Spouse starts A1 German course. Sponsor gathers income proof and housing documents in Germany. |
| Month 2-3 | Continue A1 preparation. Begin collecting Pakistani documents (nikah nama, birth certificates). Get documents attested by MoFA. |
| Month 4 | Take Goethe A1 exam. Get certified German translations of all documents. |
| Month 5 | Register on Consular Services Portal. Upload documents. Sponsor obtains Verpflichtungserklärung from Ausländerbehörde. |
| Month 6-7 | Attend embassy appointment. Submit biometrics. Pay visa fee. |
| Month 7-9 | Processing period. Embassy verifies documents with Ausländerbehörde. |
| Month 9-10 | Visa issued. Book flights. Arrange initial health insurance. |
| Month 10 | Arrival in Germany. Anmeldung. Apply for Aufenthaltserlaubnis. Enroll in integration course. |

---

*This guide was last verified in March 2026. German immigration law changes regularly. Always confirm current requirements on the [German Embassy Islamabad website](https://pakistan.diplo.de/pk-en/service/1-visa-fz-seite-1676108) and the [Consular Services Portal](https://digital.diplo.de) before applying.*

*Disclaimer: This article is for informational purposes only and does not constitute legal advice. Immigration cases vary based on individual circumstances. Always verify information with official German government sources or consult a qualified immigration lawyer (Rechtsanwalt für Ausländerrecht) for your specific situation.*
